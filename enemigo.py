...
class Enemigo:
    def __init__(self,x,y,speed_walk, speed_run,gravity,frame_rate_ms,move_rate_ms,tipe=0) -> None:
        ...
        self.walk_l = reescalar_imagen(enemigo_walk_l,tamaño_player) 
        self.walk_r = reescalar_imagen(enemigo_walk_r, tamaño_player)
        self.idle_l = reescalar_imagen(enemigo_idle_l,tamaño_player)
        self.idle_r = reescalar_imagen(enemigo_idle_r, tamaño_player)
        self.die = reescalar_imagen(Auxiliar.getSurfaceFromSpriteSheet(r"JUEGO_ON\images\ENEMIGO_1\explota\big-explosion.png",9,1),tamaño_player)

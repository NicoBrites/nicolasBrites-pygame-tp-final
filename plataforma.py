...
class Platform:
    def __init__(self, x, y, w, h, type=0) -> None:
        self.image = pygame.transform.scale(pygame.image.load(
            r"JUEGO_ON\images\Plataformas\0.png"), (w, h))

        self.rect = self.image.get_rect()
        self.rect.x = x
        self.rect.y = y
        self.rect_ground_collition = pygame.Rect(
            self.rect.x, self.rect.y, self.rect.w, GROUND_RECT_H)
...
class Techito(Platform):
    def __init__(self, x, y, w, h, type=0) -> None:
        ...
        self.image = pygame.transform.flip(pygame.transform.scale(pygame.image.load(
            r"JUEGO_ON\images\Plataformas\techito\0.png"), (w, h)), False, True)
        self.rect_ground_collition = pygame.Rect(
            self.rect.x, self.rect.y+64, self.rect.w, GROUND_RECT_H)
...
class Parecita(Platform):
    def __init__(self, x, y, w, h, type=0) -> None:
        ...
        self.image = pygame.transform.scale(pygame.image.load(
            r"JUEGO_ON\images\Plataformas\parecita\0.png"), (w, h))
        self.rect_ground_collition = pygame.Rect(
            self.rect.x, self.rect.y+64, self.rect.w, GROUND_RECT_H)
...
class Plataforma_lvl2(Platform):
    def __init__(self, x, y, w, h, type=0) -> None:
        super().__init__(x, y, w, h, type)
        self.image = pygame.transform.scale(pygame.image.load(
            r"JUEGO_ON\images\lvl2\lvl2_tiles\plataforma.png"), (w, h))
        self.rect_ground_collition = pygame.Rect(
            self.rect.x, self.rect.y, self.rect.w, GROUND_RECT_H)
...
class Piso_lvl2(Platform):
    def __init__(self, x, y, w, h, type=0) -> None:
        super().__init__(x, y, w, h, type)
        self.image = pygame.transform.scale(pygame.image.load(
            r"JUEGO_ON\images\lvl2\lvl2_tiles\0.png"), (w, h))
        self.rect_ground_collition = pygame.Rect(
            self.rect.x, self.rect.y, self.rect.w, GROUND_RECT_H)
...
class Plataforma_lvl2_dinamica(Platform):
    def __init__(self, x, y, w, h, type=0) -> None:
        ...
        self.image = pygame.transform.scale(pygame.image.load(
            r"JUEGO_ON\images\lvl2\lvl2_tiles\plataforma.png"), (w, h))
        self.rect_ground_collition = pygame.Rect(
            self.rect.x, self.rect.y+5, self.rect.w, GROUND_RECT_H)

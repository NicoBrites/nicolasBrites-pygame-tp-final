...
class FormMenuB(Form):
    def __init__(self, name, master_surface, x, y, w, h, color_background, color_border, active):
        ...
        self.boton1 = Button(master=self, x=1300, y=20, w=150, h=40, color_background=C_RED, color_border=C_BLACK,
                             on_click=self.on_click_boton1, on_click_param="form_menu_A", text="BACK", font="Verdana", font_size=30, font_color=C_BLACK)

        self.static_background = Background(
            x=0, y=0, width=w, height=h, path=r"JUEGO_ON\images\GUI\background_menu\fondo_about_finish2.png")

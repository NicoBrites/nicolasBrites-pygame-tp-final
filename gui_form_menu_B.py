...
class FormMenuB(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        self.boton2 = Button(master=self,x=0,y=200,w=400,h=40,color_background=C_PINK,color_border=C_RED,on_click=self.on_click_boton2,on_click_param="",text="MUTE",font="Verdana",font_size=30,font_color=C_BLACK)
        self.boton3 = Button(master=self,x=0,y=250,w=400,h=40,color_background=C_PINK,color_border=C_RED,on_click=self.on_click_boton3,on_click_param="form_game_L1",text="DES MUTE",font="Verdana",font_size=30,font_color=C_BLACK)
        ...
        self.txt1 = TextBox(master=self,x=0,y=50,w=240,h=40,color_background=None,color_border=None,image_background="JUEGO_ON\images\GUI\BOTOn\Button_XL_08.png",text="Text",font="Verdana",font_size=30,font_color=C_BLACK)
        self.txt2 = TextBox(master=self,x=0,y=100,w=240,h=40,color_background=None,color_border=None,image_background="JUEGO_ON\images\GUI\BOTOn\Button_XL_08.png",text="Text",font="Verdana",font_size=30,font_color=C_BLACK)
    ...
    def on_click_boton2(self,flag_sonido):
        flag_sonido = False

...
class FormGameLevel2(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        self.static_background = Background(x=0,y=0,width=w,height=h,path=r"JUEGO_ON\images\lvl2\level2_background\ultimo_fondo_edit.png")
                    ...
                    if clave == "botines":
                        for botines in valor:                    
                            if botines["botin"] == "Botin":
                                ...
                                self.lista_botinex.append(Console(x=botines["x"],y=botines["y"],w=botines["w"],h=botines["h"]))

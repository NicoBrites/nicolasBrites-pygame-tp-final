...
class FormMenuWin(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        self.txt_x1 = TextBox(master=self,x=70,y=100,w=300,h=40,color_background=C_BLACK,color_border=C_RED,image_background=None,text="GANASTE PAPACHO",font="Verdana",font_size=30,font_color=C_WHITE)
